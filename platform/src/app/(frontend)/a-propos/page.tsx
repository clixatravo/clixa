...
export const metadata: Metadata = {
  title: "À propos",
  description: `CLIXA Institute — ${DEVISE_CLIXA}. Former, certifier et accompagner les dirigeants et les organisations du continent.`,
};
    ...
    <>
      ...
      <section className="border-line relative overflow-hidden border-b px-8 py-16 lg:py-20">
        ...
        <div className="relative z-10 mx-auto max-w-[1180px]">
          <div className="eyebrow mono-label mb-5">{DEVISE_CLIXA}</div>
          ...
          <p className="text-ivory-dim/95 mb-4 max-w-[64ch] text-[1.05rem] leading-relaxed">
            ...
            opérons depuis Agadir ; Abidjan et Dakar ouvrent prochainement.
          </p>
