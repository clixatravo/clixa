  ...
  return (
    <>
      ...
      <TrailerImmersion
        ...
        sousTitre="Trailer officiel de l'institut, extraits de masterclasses en direct, retours d'expérience à chaud de nos participants et l'espace de formation des cohortes."
      />
